...
def footer():
  ...
  <div class="wheel-backdrop" id="wheelBackdrop" hidden>
    <div class="wheel-modal" role="dialog" aria-modal="true" aria-label="Spin to win">
      ...
      <p class="wheel-sub" id="wheelSub">One free spin every 12 hours &mdash; good luck.</p>
      <div class="wheel-stage">
        <div class="wheel-pointer"></div>
        <div class="wheel-disc" id="wheelDisc">
          <span class="wheel-label" style="--i:0">$1 Off Purchase</span>
          <span class="wheel-label" style="--i:1">Free Fountain Drink</span>
          <span class="wheel-label" style="--i:2">10% Off Snacks</span>
          <span class="wheel-label" style="--i:3">$3 Off $20+</span>
          <span class="wheel-label" style="--i:4">Free Candy Bar</span>
          <span class="wheel-label" style="--i:5">Try Again Later</span>
          <span class="wheel-label" style="--i:6">$1 Off Purchase</span>
          <span class="wheel-label" style="--i:7">Free Coffee</span>
        </div>
      </div>
